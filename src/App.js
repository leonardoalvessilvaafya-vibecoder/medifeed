...
const QUIZZES = [
  { type:"quiz", specialty:"Cardiologia", author:"Dr. Rafael Monteiro", time:"Há 5 min", questions:[{q:"Qual complicação vascular mais grave pode ocorrer após injeção inadvertida de preenchedor facial?",opts:["Necrose","Edema","Equimose","Eritema"],correct:0},{q:"Qual fármaco é primeira linha no manejo da IC com FE reduzida?",opts:["Digoxina","Carvedilol","Amiodarona","Diltiazem"],correct:1},{q:"O sinal de Kussmaul é característico de qual condição?",opts:["IAM","Pericardite constritiva","Estenose aórtica","Hipertensão pulmonar"],correct:1}], likes:198, refs:"https://www.acc.org" },
...
const ArticleCard = ({ item, onAuthorTap }) => (
  <div style={{position:"relative",width:"100%",height:"100%",background:item.bg,display:"flex",flexDirection:"column",justifyContent:"center",padding:"100px 64px 100px 18px"}}>
    ...
    <button style={{marginTop:18,alignSelf:"flex-start",background:"rgba(255,255,255,0.1)",backdropFilter:"blur(16px)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:28,color:"white",fontSize:12,fontWeight:700,height:56,padding:"0 24px",cursor:"pointer",display:"flex",alignItems:"center",gap:6}}>
      Ler artigo completo →
    </button>
  </div>
);
